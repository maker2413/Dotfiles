...
-- {{{ Wibar
-- Create a textclock widget while also passing in format for 12 hour clock
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "WWW", "Chat", "Term", "Emacs", "Game", "Music", "VM", "HTOP", "Steam" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- awful.key({ modkey, "Control" }, "h", function () awful.util.spawn("htop") end,
